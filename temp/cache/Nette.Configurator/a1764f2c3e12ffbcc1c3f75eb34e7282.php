<?php
// source: C:\wamp\www\rocnikovy_projekt\app/config/config.neon 
// source: C:\wamp\www\rocnikovy_projekt\app/config/config.local.neon 

/**
 * @property Forum\AuthmeRepository $amr
 * @property Nette\Application\Application $application
 * @property Forum\Authenticator $authenticator
 * @property Nette\Caching\Storages\FileStorage $cacheStorage
 * @property Nette\DI\Container $container
 * @property Forum\CategoriesRepository $cr
 * @property Nette\Http\Request $httpRequest
 * @property Nette\Http\Response $httpResponse
 * @property Forum\MessageRepository $mr
 * @property Nette\Bridges\Framework\NetteAccessor $nette
 * @property Nette\Application\IRouter $router
 * @property Forum\RepliesRepository $rr
 * @property Nette\Http\Session $session
 * @property Forum\TopicsRepository $tr
 * @property Forum\UserRepository $ur
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'forum\\authenticator' => array('authenticator'),
			'forum\\repository' => array('amr', 'cr', 'mr', 'rr', 'tr', 'ur'),
			'forum\\authmerepository' => array('amr'),
			'forum\\categoriesrepository' => array('cr'),
			'forum\\messagerepository' => array('mr'),
			'forum\\repliesrepository' => array('rr'),
			'forum\\topicsrepository' => array('tr'),
			'forum\\userrepository' => array('ur'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wamp\\www\\rocnikovy_projekt\\app',
			'wwwDir' => 'C:\\wamp\\www\\rocnikovy_projekt\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\wamp\\www\\rocnikovy_projekt\\app/../temp',
			'authmeHash' => 'MD5',
		));
	}
	...
	/**
	 * @return Forum\AuthmeRepository
	 */
	public function createServiceAmr()
	{
		$service = new Forum\AuthmeRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return Forum\Authenticator
	 */
	public function createServiceAuthenticator()
	{
		$service = new Forum\Authenticator($this->getService('amr'), $this->getService('ur'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wamp\\www\\rocnikovy_projekt\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	/**
	 * @return Forum\CategoriesRepository
	 */
	public function createServiceCr()
	{
		$service = new Forum\CategoriesRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=rocnikovy_projekt', 'root', NULL, array('lazy' => TRUE));
	...
	/**
	 * @return Forum\MessageRepository
	 */
	public function createServiceMr()
	{
		$service = new Forum\MessageRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wamp\\www\\rocnikovy_projekt\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wamp\\www\\rocnikovy_projekt\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	/**
	 * @return Forum\RepliesRepository
	 */
	public function createServiceRr()
	{
		$service = new Forum\RepliesRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return Forum\TopicsRepository
	 */
	public function createServiceTr()
	{
		$service = new Forum\TopicsRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return Forum\UserRepository
	 */
	public function createServiceUr()
	{
		$service = new Forum\UserRepository($this->getService('database.default.context'));
		return $service;
	}
